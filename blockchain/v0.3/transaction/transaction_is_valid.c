...
static int check_inputs(int tx_in_size, int unspent_size, int tx_out_size, transaction_t const *transaction, llist_t *all_unspent)
{
...
int transaction_is_valid(transaction_t const *transaction, llist_t *all_unspent)
{
    ...
    return (check_inputs(tx_in_size, unspent_size, tx_out_size, transaction, all_unspent));
}