 ...
 * @coinbase: Pointer to the coinbase transaction to validate
 * @block_index: Index of the block containing the coinbase transaction
 *
	...
	uint32_t block_index)
{
	...
	if (memcmp(transaction_hash(coinbase, hash_buf), coinbase->id,
